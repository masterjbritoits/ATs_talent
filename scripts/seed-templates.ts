...
const TEMPLATES: Array<{
  type: string;
  name: string;
  subjects: { pt: string; es: string; en: string };
  bodies: { pt: string; es: string; en: string };
}> = [
  {
    type: "APPLICATION_RECEIVED",
    name: "Agradecimento de Candidatura",
    subjects: {
      pt: "Candidatura Recebida — {{jobTitle}}",
      es: "Candidatura Recibida — {{jobTitle}}",
  ...
  },
  {
    ...
    subjects: {
      pt: "Resumo da Nossa Conversa — {{jobTitle}}",
      es: "Resumen de Nuestra Conversación — {{jobTitle}}",
      en: "Summary of Our Conversation — {{jobTitle}}",
    },
    bodies: {
  ...
  },
  {
    ...
    subjects: {
      pt: "Convite para Entrevista Comportamental — {{jobTitle}}",
      es: "Invitación a Entrevista de Comportamiento — {{jobTitle}}",
      en: "Invitation to Behavioural Interview — {{jobTitle}}",
    },
    bodies: {
  ...
  },
  {
    ...
    subjects: {
      pt: "Convite para Entrevista Técnica — {{jobTitle}}",
      es: "Invitación a Entrevista Técnica — {{jobTitle}}",
      en: "Invitation to Technical Interview — {{jobTitle}}",
    },
    bodies: {
  ...
  },
  {
    ...
    subjects: {
      pt: "Convite para Entrevista em Projeto — {{jobTitle}}",
      es: "Invitación a Entrevista de Proyecto — {{jobTitle}}",
      en: "Invitation to Project Interview — {{jobTitle}}",
    },
    bodies: {
  ...
  },
  {
    ...
    subjects: {
      pt: "Convite para Entrevista Final — {{jobTitle}}",
      es: "Invitación a Entrevista Final — {{jobTitle}}",
      en: "Invitation to Final Interview — {{jobTitle}}",
    },
    bodies: {
  ...
  },
  {
    ...
    subjects: {
      pt: "Proposta de Colaboração — {{jobTitle}} — ITSector",
      es: "Propuesta de Colaboración — {{jobTitle}} — ITSector",
      en: "Collaboration Proposal — {{jobTitle}} — ITSector",
    },
    bodies: {
  ...
  },
  {
    ...
    name: "Feedback — Não Progressão",
    subjects: {
      pt: "Processo de Seleção — {{jobTitle}} — ITSector",
      es: "Proceso de Selección — {{jobTitle}} — ITSector",
      en: "Selection Process — {{jobTitle}} — ITSector",
    },
    bodies: {
      pt: `Exmo(a) {{candidateName}},\n\nAgradecemos o seu interesse na posição de {{jobTitle}} na ITSector e o tempo que dedicou ao nosso processo de seleção.\n\nApós cuidadosa análise, informamos que, neste momento, não iremos avançar com a sua candidatura para esta posição. Esta decisão não reflete o seu valor profissional, mas sim a necessidade de alinhar o perfil com as especificidades atuais da função.\n\nO seu currículo ficará registado na nossa base de dados e poderemos contactá-lo(a) para oportunidades futuras que se adequem ao seu perfil.\n\nDesejamos-lhe os maiores sucessos na sua carreira.\n\nCom os melhores cumprimentos,\n{{recruiterName}}\nITSector — Recrutamento`,
      es: `Estimado/a {{candidateName}},\n\nAgradecemos su interés en el puesto de {{jobTitle}} en ITSector y el tiempo que dedicó a nuestro proceso de selección.\n\nTras un cuidadoso análisis, le informamos que, en este momento, no vamos a continuar con su candidatura para esta posición. Esta decisión no refleja su valor profesional, sino la necesidad de ajustar el perfil a las especificidades actuales del puesto.\n\nSu currículum quedará registrado en nuestra base de datos y podremos contactarle para oportunidades futuras que se adapten a su perfil.\n\nLe deseamos mucho éxito en su carrera.\n\nUn cordial saludo,\n{{recruiterName}}\nITSector — Selección`,
  ...
  },
  {
    ...
    subjects: {
      pt: "O Seu Perfil — ITSector Talent Pool",
      es: "Su Perfil — ITSector Bolsa de Talento",
      en: "Your Profile — ITSector Talent Pool",
    },
    bodies: {
      pt: `Exmo(a) {{candidateName}},\n\nO seu perfil profissional despertou o interesse da nossa equipa de recrutamento e temos o prazer de o(a) informar que foi incluído(a) na nossa Talent Pool.\n\nIsto significa que o seu perfil será considerado prioritariamente em futuras oportunidades que correspondam às suas competências e experiência.\n\nNão é necessária qualquer ação da sua parte. Entraremos em contacto quando surgir uma oportunidade adequada.\n\nObrigado pela sua confiança na ITSector.\n\nCom os melhores cumprimentos,\n{{recruiterName}}\nITSector — Recrutamento`,
      es: `Estimado/a {{candidateName}},\n\nSu perfil profesional ha despertado el interés de nuestro equipo de selección y nos complace informarle de que ha sido incluido/a en nuestra Bolsa de Talento.\n\nEsto significa que su perfil será considerado prioritariamente en futuras oportunidades que correspondan a sus competencias y experiencia.\n\nNo es necesaria ninguna acción por su parte. Nos pondremos en contacto cuando surja una oportunidad adecuada.\n\nGracias por su confianza en ITSector.\n\nUn cordial saludo,\n{{recruiterName}}\nITSector — Selección`,
...
async function main() {
  ...
  console.log(`✓ Seeded ${count} email templates (${TEMPLATES.length} types × PT/ES/EN).`);
}

main()
  .catch((e) => { console.error(e); process.exit(1); })
  .finally(() => prisma.$disconnect()   name: "Agradecimento de Candidatura",
    subjects: {
      pt: "Candidatura Recebida — {{jobTitle}}",
      es: "Candidatura Recibida — {{jobTitle}}",
      en: "Application Received — {{jobTitle}}",
